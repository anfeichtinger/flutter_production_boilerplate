...
|-----------------------------------------------------------------------------|----------|-----------------------------------------------------|
| [Bloc](https://pub.dev/packages/bloc)                                       | ^9.2.1   | State management*                                    |
| [Flutter Bloc](https://pub.dev/packages/flutter_bloc)                       | ^9.1.1   | State management*                                    |
| [Hydrated Bloc](https://pub.dev/packages/hydrated_bloc)                     | ^11.0.0  | Persists Bloc state with Hive                        |
| [Equatable](https://pub.dev/packages/equatable)                             | ^2.1.0   | Easily compare custom classes, used for Bloc states* |
